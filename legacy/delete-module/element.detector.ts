// src\modules\product\product.detector.ts

/**
 * Тимчасовий сервіс автоматичного визначення виробу.
 * src\modules\elements\element.detector.ts
 *
 * Після завершення нового імпортера (ImportContext + Catalog)
 * має бути вилучений.
 */
