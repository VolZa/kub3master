...
//   if (parts.length < 2) {
//     throw new Error('Invalid structured line: ' + line);
//   }

//   return {
//     prefix: parts[0],
//     code: parts[1],
//     suffix: parts.length > 3 ? parts[2] : undefined,
//     qty: Number(parts[parts.length - 1] || 1),
//   };
// }
...
//   // 🔥 просто делегуємо
//   return buildBOMFromTable(parsedParent, tableRows, repo, catalogRepo);
// }
